...
def new_alias():
    ...
    entity_id={}
    id_entity={}
    with open(os.path.join(common_path, 'kb_data'), 'r') as f:
        for line in f:
            ...
            for n in entity_name:
                if n in entity_id:
                    ...
                    entity_id[n] = set()
                    entity_id[n].add(subject_id)
    with open(os.path.join(common_path, 'train.json')) as f:
        entity_alias_num={}
        for line in f:
            temDict = json.loads(line)
...
def kb_processing():
    ...
    pd.to_pickle(entity_id,'../../data/entity_link_ccks_baidu/entity_id.pkl')
    pd.to_pickle(id_entity, '../../data/entity_link_ccks_baidu/id_entity.pkl')
    pd.to_pickle(type_index, '../../data/entity_link_ccks_baidu/type_index.pkl')
    pd.to_pickle(id_type, '../../data/entity_link_ccks_baidu/id_type.pkl')
    pd.to_pickle(id_text, '../../data/entity_link_ccks_baidu/id_text.pkl')
