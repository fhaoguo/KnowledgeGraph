...
data_root_path = '../data/entity_link'
...
def GenerateCand(file_path, save=True):
    ...
    for line in open(os.path.join(data_root_path, 'basic_data/' + file_path), encoding='utf-8'):
    ...
    if save:
        ...
        with open(os.path.join(data_root_path, "generated/cand.json"), 'w', encoding='utf-8') as jsonfile:
            jsonfile.write(jsonstr)
        jsonstr = json.dumps(ent_dic, ensure_ascii=False, indent=4)
        with open(os.path.join(data_root_path, "generated/entity.json"), 'w', encoding='utf-8') as jsonfile:
            jsonfile.write(jsonstr)
...
def GeneratePairwaiseSample(file_path, cand_dic, ent_dic, is_train=True):
    ...
    out_file = open(os.path.join(data_root_path, 'generated/' + data_fname), 'w', encoding='utf-8')
...
class DataEncoder(object):
    ...
    def __init__(self,
                 word2idx,
                 type2label,
                 user_word_dict=os.path.join(data_root_path, "generated/mention.txt")):
